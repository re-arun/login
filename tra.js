...
const App = () => {
  return (
    <SafeAreaView style={styles.container}>
      <View>
      <Text style={styles.text}>Log In To Mobiloitte</Text>
...
<Text style={styles.inputdom}>New User ?{' '} 
<Text
style={styles.inputdoml}
onPress={() => this.props.navigation.navigate('../signup.js')} >
